...
export const SongProvider = props => {
  const [songs, setSongs] = useState([
    ...
    { id: 5, title: 'So High', artist: 'Noisecontrollers', genre: 'Hardstyle', rating: '5' },
    {
      id: 6,
      title: 'Beat As One',
      artist: 'D-Block & S-te-Fan, F8trix',
      genre: 'Hardstyle',
      rating: '5'
    },
    {
      id: 7,
      title: 'The Promised Land - The Viper Remix',
      artist: 'Paul Elstak, The Viper',
      genre: 'Hardcore',
      rating: '5'
    },
